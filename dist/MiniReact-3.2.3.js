  ...
  function useReducer(reducer, initialState) {
    ...
    const dispatch = (action) => {
      if (wipFiber.alternate) {
        wipFiber.alternate.hooks[hookIndex].queue.push(action);
      } else {
        wipFiber.hooks[hookIndex].queue.push(action);
      }
      scheduleUpdate();
    };
